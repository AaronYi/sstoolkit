...
- (void)testColorWithHex {
	...
	GHAssertEqualObjects(red, [UIColor colorWithHexString:@"ff0000ff"], nil);
	...
	GHAssertEqualObjects(green, [UIColor colorWithHexString:@"00ff00ff"], nil);
	...
	GHAssertEqualObjects(blue, [UIColor colorWithHexString:@"0000ffff"], nil);
	
	UIColor *bleh = [UIColor colorWithRed:1.0f green:0.2f blue:0.0f alpha:0.2f];
	GHAssertEqualObjects(bleh, [UIColor colorWithHexString:@"ff330033"], nil);
}
